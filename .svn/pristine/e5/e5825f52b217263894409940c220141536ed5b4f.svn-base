<template>
  <div class="site-ground">
    <div class="sysTitleName">
      <div class="site-navbar-img">
    ...
    <nav class="site-navbar" :class="'site-navbar--' + navbarLayoutType">
      <div class="site-navbar__body clearfix">
        <el-menu
          ...
          mode="horizontal">
          <el-menu-item class="site-navbar__switch site-navbar-li" index="0" @mouseover.native="sidebarFold = false">
            <icon-svg name="zhedie"></icon-svg>
          </el-menu-item>
        </el-menu>
        <!--<el-menu style="position: fixed; top:0; display: inline; left: 20%;"-->
        <!--class="site-navbar__menu"-->
        <!--mode="horizontal">-->
        <!--<el-menu-item class="site-navbar__switch site-navbar-li" index="1" style="cursor: text; text-align: center; width: 100%;">-->
        <!--<div class="site-navbar-title">-->
          <!--<div class="site-navbar-img">-->
        <!--<img src="../assets/img/logo.png" alt="logo"></div>-->
        <!--鄂州市遏制重特大事故双重预防机制信息平台-->
        <!--</div>-->
  ...
  export default {
    ...
    methods: {
      ...
      webSocketOnMessage(e) {
        ...
        this.smallMessageVisible = true
        this.$nextTick(() => {
          this.$refs.smallMessage.init(this.redata)
        })
      },
