...
<script>
  ...
  import MoniInfoVideoMoni from './videoView'
  import MoniInfoPersLoca from './../personnel/personnelInfo'
  import MoniInfoHistData from './moniInfo-histData'
export default {
    components: {echarts, MoniInfoHistData, MoniInfoPersLoca, MoniInfoVideoMoni, MoniInfoRealTime},
    data () {
      return {
        activeTab: '1',
        visible: false,
