<template>
  <div class="video_content" :style="{height: styleHeight}">
    <!-- 顶部搜索框-->
...
<script>
  ...
  export default {
    ...
    methods: {
      initImg () {
        this.img1 = require('../../../assets/img/video/quan.png')
        this.img2 = require('../../../assets/img/video/RealPlayAll.png')
        this.img3 = require('../../../assets/img/video/StopAll.png')
        this.img4 = require('../../../assets/img/video/Capture.png')
      },
      bigImg (x) {
        if (x == 1) {
          this.img2 = require('../../../assets/img/video/SelRealPlayAll.png')
        } else if (x == 2) {
          this.img3 = require('../../../assets/img/video/SelStopAll.png')
        } else if (x == 3) {
          this.img4 = require('../../../assets/img/video/SelCapture.png')
        }
      },
      normalImg (x) {
        if (x == 1) {
      ...
      initVideo () {
        ...
        if (iRet == -2) {
          ...
          // if (down == true) {
          //   window.location.href = '../../../assets/plugins/video/WebComponentsKit.exe'
          // }
          return
        }
...
<style scoped>
  ...
  .video_content .left[data-v-865d5296] {
    float: left;
    width: 70%;
    height: 95%;
    border: 2px #133050 solid;
  }
  .all_search select[data-v-865d5296] {
    border: 1px solid #dcdfe6;
    border-radius: 4px;
    height: 40px;
    line-height: 100%;
