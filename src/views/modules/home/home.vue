      ...
      <el-col :span="8" style="height: 100%;">
            ...
            <div class="cityUnit">
              <div>
                ...
                <div class="modData" :class="{'riskSyle':animate1}" style="color: #d81e06; cursor: pointer;"
                     @click="riskChangeSms()">
                  <span v-text="riskEntCount" class=""></span><span>家</span>
                </div>
              </div>
              <div>
                <div class="modImgTxt">
                ...
                <div class="modData" :class="{'riskSyle':animate2}" style="color: #ff9d4d; cursor: pointer;"
                     @click="realDataSms()">
                  <span v-text="realDataEntCount"></span><span>家</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="modulGround moduleTop">
          ...
          <div class="moduleContent right-center">
            ...
            <el-row style="height: 72%;" >
              <el-col :span="10" style="height: 100%;" >
                <div id="RiskGauge" style="height: 100%;" ></div>
              </el-col>
              <el-col :span="14" style="height: 100%;" >
                <div id="RiskBar" style="height: 100%;" ></div>
              </el-col>
            </el-row>
          </div>
        </div>
        ...
        <div class="modulGround moduleTop">
          ...
          <div class="moduleContent right-down">
            ...
            <el-row style="height: 72%;" >
              <el-col :span="10" style="height: 100%;" >
                <div style="height: 100%;" id="HiddenGauge"></div>
              </el-col>
              <el-col :span="14" style="height: 100%;" >
                <div style="height: 100%;" id="HiddenBar"></div>
              </el-col>
            </el-row>
          </div>
        </div>
...
<script>
  ...
  export default {
    data () {
      return {
        styleHeight: window.screen.availHeight - 56 + 'px',
