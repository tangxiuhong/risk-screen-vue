        ...
        <div class="riskDynaAnal-up-left">
          ...
          <div class="riskDynaAnal-up-left-down">
            ...
            <div class="riskDynaAnal-up-left-down-right">
              <div style="font-weight: normal; text-align: left;">当前风险等级：</div>
              <div class="riskDynaAnal-up-left-down-right-color" :style="{color:colorTxt}"
                   :class="{'riskSyle':animate}">{{riskLevelColor}}
              </div>
          ...
          <div class="riskDynaAnal-down-left-up">
            ...
            <div class="riskDynaAnal-down-left-up-con">
              <div class="riskDynaAnal-down-left-up-con-down">
                <div style="margin-bottom: 15px; text-align: center">鄂州：{{weatherUpdateTime}} 更新</div>
                <div class="riskDynaAnal-down-left-up-con-down-left">
                  <div class="riskDynaAnal-down-left-up-con-center">
                    <div style="background-color:#F68D3B; padding: 3px; display: inline-block">
                      {{weatherAlarmInfo}}
                    </div>
                  </div>
                  <div style="font-size: 50px;font-weight: bold; position: relative; margin-top: 15px;">
                ...
                <div class="riskDynaAnal-down-left-up-con-down-right">
                  <div class="riskDynaAnal-down-left-up-con-down-right-top">
                    <div style="background-color: #F9DA65;border-radius: 10px; padding: 2px 5px; display: inline-block;">{{weatherAqiInfo}}</div>
                  </div>
  ...
  export default {
    data () {
      return {
        ...
        colorTxt: '',
        selectList: false,
        styleHeight: window.screen.availHeight - 130 + 'px',
        options: [],
        userId: '',
        webSocket: null,
        animate: '',
    ...
    methods: {
      ...
      dataHandle (redata) {
        ...
        if (this.riskLevel === 1) {
          this.riskLevelColor = '预警'
          this.riskLevelName = '红色预警'
          ...
          this.riskLevelColor = '预警'
          this.riskLevelName = '超红色预警'
          this.colorTxt = '#c30000'
        }
        if (this.riskLevelColor == '预警') {
          this.animate = true
        }
        this.riskPieArr = []
