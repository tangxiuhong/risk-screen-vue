      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <el-button type="text" size="small"
                     @click="downloadHandle(scope.row.attachmentPath)"><p style="color:#fff;font-size:18px;">下载</p></el-button>
        </template>
      </el-table-column>
    </el-table>
    <el-pagination
...
<script>
  export default {
    ...
    methods: {
      ...
      // 下载
      downloadHandle (attachmentPath) {
        window.location.href = attachmentPath
      }
    }
  }
</script>
